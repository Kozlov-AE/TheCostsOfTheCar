...
namespace ViewModel
{
    public class RelayCommand : ICommand
    {
        ...
        /// <summary>Initializes a new instance of the RelayCommand class that
        /// can always execute.</summary>
    ...
    /// <summary>This class allows delegating the commanding logic to methods passed as parameters,
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        /// <summary>Raise <see cref="RelayCommand{T}.CanExecuteChanged" /> event.</summary>
        public void RaiseCanExecuteChanged()
        {
            CanExecuteChanged?.Invoke(this, EventArgs.Empty);
        }

        /// <summary>Determines whether this instance can execute the specified parameter.</summary>
